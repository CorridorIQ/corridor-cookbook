...
3. **Tell the user what to do**: copy the block, run `/clear` in Claude Code or open a fresh chat in Cowork, paste it, and the work continues where it left off.

Done when the handoff is on screen and saved, and someone brand new could pick up the work from that block alone.
